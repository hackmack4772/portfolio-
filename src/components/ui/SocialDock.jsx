      ...
      {links.map((link, idx) => {
        ...
        return (
          <a
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full glass-premium border border-white/[0.08] text-text-muted hover:text-accent hover:border-accent hover:shadow-[0_0_15px_var(--accent-color)] transition-all duration-300 cursor-pointer"
